...
Config['CasinoHeist'] = {
    ...
    ['rewardItems'] = { -- you need to add them to database
        diamondTrolly = { 
            ...
            sellPrice = 800, -- for buyer sell price
        },
        goldTrolly = { 
            item = 'gold', 
            count = 1,
...
Strings = {
    ['start_heist'] = 'Appuyer sur ~INPUT_CONTEXT~ pour commencer Diamond Casino Heist',
    ['wait_nextheist'] = 'Tu dois attendre pour faire un second braquage',
    ['minute'] = 'minute.',
    ['need_item'] = 'Tu en as besoin: ',
    ['police_alert'] = 'Alerte au braquage de casino ! Vérifiez votre GPS.',
    ['go_rappel'] = 'Aller en rappel',
    ['rappels_busy'] = 'Tous les rappels sont occupés, réessayez dans quelques secondes.',
    ['rappel_start'] = 'Appuyer sur ~INPUT_CONTEXT~ descendre en rappel',
    ['rappel_action'] = '~INPUT_MOVE_DOWN_ONLY~ Vers le bas / ~INPUT_PICKUP~ Faire glisser',
    ['go_base'] = 'Aller au sous-sol',
    ['emp_activated'] = 'EMP est actif, soyez prudent !',
    ['emp_deactivated'] = 'EMP est désactivé, soyez prudent ! Allez aux portes du milieu.',
    ['swipe_card_base'] = 'Appuyer sur ~INPUT_CONTEXT~ glisser la carte',
    ['door_opened'] = 'Les portes sont ouvertes. Allez au coffre-fort.',
    ['laser_drill'] = 'Appuyer sur ~INPUT_CONTEXT~ percer au laser',
    ['vault_open'] = 'Dépêche-toi! Vérifiez au gps pour sortir du casino. Vous devrez à nouveau utiliser la porte du personnel via.',
    ['grab'] = 'Appuyer sur ~INPUT_CONTEXT~ prendre un chariot',
    ['lockbox_drill'] = 'Appuyer sur ~INPUT_CONTEXT~ pour percer le coffre',
    ['hack_keypad'] = 'Appuyer sur ~INPUT_CONTEXT~ pour pirater le clavier',
    ['exit_casino'] = 'Appuyer sur ~INPUT_CONTEXT~ pour sortir du casino',
    ['deliver_to_buyer'] = 'Livrer le butin à l\'acheteur',
    ['base_blip'] = 'Sous-sol',
    ['middle_doors_blip'] = 'Portes du milieu',
    ['vault_blip'] = 'Sauter',
    ['exit_blip'] = 'Quitter le casino',
    ['buyer_blip'] = 'Acheteur'
}
